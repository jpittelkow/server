...
ATTR_POST_URL: Final[str] = "ai_radio_post_url"  # local path or url of the rendered break
...
ATTR_POST_GAIN_DB: Final[str] = "ai_radio_post_gain_db"  # level applied to the voice
